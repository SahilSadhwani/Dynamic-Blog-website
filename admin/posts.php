...
<!--          <p>This is a great starting point for new custom pages.</p>-->
             <div class="container-fluid">
                ...
                $categories = $cat->readAllCategories();
                ...
                <form action="posts/insert" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-md-12">
                                <div class="form-label-group">
                                    <input type="text" id="post_tags" name="post_tags" class="form-control" placeholder="Post Title">
                                    <label for="post_tags">Post Tags</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-label-group">
                                    <input type="file" id="post_image" name="post_image" class="form-control" placeholder="Post Image" accept="image/*">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" name="publish_post">Publish Post</button>
                </form>
